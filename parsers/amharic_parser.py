...
PROPERTY_KEYWORDS = [
    "ቤት", "ሽያጭ", "ሺያጭ", "ሽያች", "ሺያች", "ኪራይ", "ጨረታ", "ጨርታ", "ሃራጅ", "ሐራጅ", "ማስታወቅያ", "ሱሚ", "የሐራጅ", "የጨረታ", "ሽያይ", "ለሽጡ", "ኮንዶሚኒየም", "ቪላ", "አፓርታማ", "መሬት",
    "ህንጻ", "ሱቅ", "መጋዘን", "ቢሮ", "ንግድ", "የንግድ", "የቤት", "ሳይት",
    "House", "Sale", "Rent", "Auction", "Condominium", "Villa", "Apartment", "Land",
    "Building", "Shop", "Warehouse", "Office", "Commercial", "Residential", "Site"
]
