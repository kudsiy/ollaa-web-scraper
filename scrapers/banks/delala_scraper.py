"""
Delala App scraper.
Scrapes property listings from delalaapp.com.
"""
import logging
...
class DelalaAppScraper(BaseScraper):
    """
    Scraper for Delala App property listings.
    """
    
    base_url = "https://delalaapp.com"
    source_name = "Delala App"
    ...
    def scrape(self) -> ScrapeResult:
        ...
        try:
            self.logger.info("Starting Delala App scrape")
            ...
            for url in pages_to_try:
                ...
                if soup:
                    cards = soup.select('.listing-card, .property-card, .listing-item, article, .item, .col-md-4, .col-sm-6')
            ...
            self.logger.error(f"Error during Delala App scrape: {e}")
