...
class AbyssiniaBankScraper(BaseScraper):
    """
    ...
    def scrape(self) -> ScrapeResult:
        ...
        try:
            self.logger.info("Starting Abyssinia Bank scrape")
            
            auction_paths = ["/tenders", "/category/auction", "/የሐራጅ-ሽያጭ-ማስታወቂያ"]
            ...
            self.logger.error(f"Error during Abyssinia Bank scrape: {e}")
    ...
    def _parse_card_element(self, card) -> ScrapedListing:
        ...
        try:
            ...
            title = title_elem.get_text(strip=True) if title_elem else "Abyssinia Bank Auction"
